function D_mat = hemispheroidal_harmonic_math_basis(max_n, thetas, phis, hemispheroidal_type)
% Imeplementation: Mahmoud Shaqfa.

if hemispheroidal_type == "oblate"
    xi = 2. * sin(thetas) - 1;
elseif hemispheroidal_type == "prolate"
    xi = 1 - 2. * cos(thetas);
end
